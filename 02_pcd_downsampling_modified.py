...
# 시각화 확인 (original 제거, downsample된 포인트 클라우드만 시각화)
visualize_point_clouds([voxel_downsample_pcd], 
                       window_name="Voxel Downsampled (Blue)", point_size=2.0)

visualize_point_clouds([sor_downsampled_pcd], 
                       window_name="SOR (Red)", point_size=2.0)

visualize_point_clouds([ror_downsampled_pcd], 
                       window_name="ROR (Green)", point_size=2.0)